...
def params_result_handler(response, a, b, c, magnitude="unsigned"):
    decimal=0
    if magnitude=="unsigned":
        decimal=unsigned_hex_string_to_decimal(response)

    elif magnitude=="signed":
...
#
#
# def params_divided2_55(response):
#     decimal = unsigned_hex_string_to_decimal(response)
...
#
#
# def params_Identical(response):
#     decimal = unsigned_hex_string_to_decimal(response)
#     return decimal
#
#
# def params_divided512(response):
#     decimal = unsigned_hex_string_to_decimal(response)
...
#
#
# def params_sub40(response):
#     decimal = unsigned_hex_string_to_decimal(response)
#     phy=subtract_value(decimal, 40.)
#     return phy
#
#
# def params_sub127(response):
#     decimal = unsigned_hex_string_to_decimal(response)
...
#
#
# def params_divided128(response):
#     decimal = unsigned_hex_string_to_decimal(response)
...
#
#
# def params_0356(response):
#     decimal = unsigned_hex_string_to_decimal(response)
#     phy=times_divided(decimal, 1., 256.)
#     return phy
#
